...
> 本目录冻结 V1 决策及 V2 重启前的过渡 ADR，只用于历史追溯、解释现有代码和指导删除迁移。其状态表是归档时快照，不是 V2 的现行规范；V2 决策见 [`../../README.md`](../../README.md)。归档正文中的跨目录相对链接可能仍指向迁移前位置。

本索引是 V1 冻结快照，曾把“决策是否接受”和“实现是否落地”分开记录；当时的整改快照见
[`2026_08_review_remediation.md`](../../../planning/archived/v1/2026_08_review_remediation.md)。
...
| [022](./adr_022_request_graph.md) | Superseded by ADR-034 | V1 基线已落地；V2 待删除 | V1 已人工复核 | 历史实现依据 |
| [023](./adr_023_declarative_dataflow.md) | Superseded by ADR-034 | V1 MVP 已落地；V2 待删除 | V1 owner 已签收 | 历史实现与清理依据 |
...
| [026](./adr_026_response_masker.md) | Superseded by ADR-034 | V1 部分落地；V2 待删除 | 不再继续 V1 签收 | 历史实现与清理依据 |
| [027](./adr_027_url_session_param_stripping.md) | Accepted | 实现已提交 | 待人工 | 纳入 P0-10 firewall 总签收 |
| [028](./adr_028_declarative_crypto_ops.md) | Superseded by ADR-034 | V1 已落地；V2 待删除 | 不再继续 V1 签收 | 随 dataflow 退役 |
...
| [031](./adr_031_dataflow_seed.md) | Superseded by ADR-034 | 未落地，不再实现 | 不适用 | 随 dataflow 退役 |
| [032](./adr_032_app_tunnel_embedding.md) | Proposed | 禁止实现 | 待人工评审 | 接受前不得合并 transport 实现 |
| [033](./adr_033_production_sideload.md) | Superseded by ADR-034 | 未落地，不再实现 | 不适用 | V2 改为支持平台按 digest 信任 local unsigned |
| [034](./adr_034_v2_trust_model.md) | Accepted（V2） | 决策已接受；实现未开始 | 后继契约/核心改动须人工复核 | V2 总纲；显式覆盖 V1 adapter 凭证与执行信任边界 |
