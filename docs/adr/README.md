...
| [002](./adr_002_trust_model.md) | Accepted；**§2.3 digest v2 已签收（owner NanCunChild 2026-09-09）** | 部分落地；§2.3 digest v2 **规格已签收、实现未开工**；§2.1.1 Sideload 消歧（2026-09-08）未落地 | **§2.3 规格签收完成**；实现落地后仍须人工复核（红线 #4）；§2.1.1 待人工 | P0-01/P0-14 |
...
| [018](./adr_018_adapter_distribution.md) | Accepted；**§2.9.1 digest v2 已签收（owner NanCunChild 2026-09-09）** | 部分落地；§2.9.1 **规格已签收、实现未开工** | **§2.9.1 规格签收完成**；实现落地后仍须人工复核（红线 #4） | P0-01/P0-15、P3-07/P3-08 |
