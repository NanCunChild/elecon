...
- **文档版本**：0.1
- **盘点日期**：2026-07-24
- **适用分支**：`refactor/request-graph-migration`（历史）
- **归档说明（2026-08-07）**：本文保留 2026-07 requestGraph 迁移期的代码观察，包含已迁出的 adapter 路径、`stripEchoes` 过渡实现和当时的 ADR 状态，**不得作为当前实现或决策状态源**。当前架构入口见 [`../architecture.md`](../architecture.md)，决策/落地状态见 [`../adr/README.md`](../adr/README.md)。
