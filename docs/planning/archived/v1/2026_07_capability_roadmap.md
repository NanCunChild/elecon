...
- Android 路径最成熟；本条为 V1 规划，原 iOS 约束见 `docs/adr/archived/v1/adr_010_ios_appstore.md`，V2 由 ADR-000 §5.1 重新裁定。
...
已确认的对象是西电一卡通 URL query 中的 `openid`。V1 ADR-020 曾裁定该路径（见 `docs/adr/archived/v1/adr_020_url_query_credential.md`）：
