...
| R2 | card openid 落 URL | **V1 ADR-020 曾接受**（[`adr_020_url_query_credential.md`](../adr/archived/v1/adr_020_url_query_credential.md)：`type: query` + 核心收割/注入）。V2 不再以该方案作为现行规范 |
