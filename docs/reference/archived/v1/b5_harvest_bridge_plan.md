...
> 历史依据：[V1 ADR-009](../adr/archived/v1/adr_009_fetch_credential.md) §2.4（收割判据 b + 匹配算法）·
> [V1 ADR-012](../adr/archived/v1/adr_012_credential_store.md) §2.2/§2.4/§2.5 · [Track B 计划](./track_b_imperative_runtime_plan.md) §4。
