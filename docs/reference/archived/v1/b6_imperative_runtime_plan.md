...
> 历史依据：[V1 ADR-009](../adr/archived/v1/adr_009_fetch_credential.md) §2.1（数据流）/ §2.5 / §2.7（限额）/ §2.8 ·
> [V1 ADR-003](../adr/archived/v1/adr_003_transport.md)（transport 出网）· [V1 ADR-005](../adr/archived/v1/adr_005_runtime.md)（QuickJS 双端）·
