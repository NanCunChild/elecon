...
>
> **时效（2026-09-10 更新）**：bundle digest v2（P0-01）已于 **2026-09-09 两端落地、CI 全绿**，
> 本文正文按 v2 校订完毕，`【过渡】` 标记已清空——你现在读到的就是当前形态。
> **唯一尚未发生的事**：仓内既有 official 产物仍是 v1 签名，须经一次离线重签仪式才能在 v2 下加载。
> 那是维护者侧的动作，**不影响你写 adapter**。
