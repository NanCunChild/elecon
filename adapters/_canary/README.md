...
版本差异、`avoided` 清单与迁移策略见 [V1 ADR-008](../../docs/adr/archived/v1/adr_008_client_runtime.md) §3。
...
`_canary` **不是可分发 adapter**，故意不带 manifest：它由双跑 smoke 直接加载 `declarative/index.js`，
